              ...
              <form method="post" action="action/update_karyawan.php">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" placeholder="nik" name="nik" value="<?php echo $data['nik']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputname">Nama Lengkap</label>
                    <input type="name" class="form-control"  placeholder="nama lengkap" name="nama" value="<?php echo $data['nama']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputposisi">Posisi</label>
                    <input type="posisi" class="form-control"  placeholder="Posisi" name ="posisi"value="<?php echo $data['posisi']; ?>">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputtelepon">Telepon</label>
                    <input type="telepon" class="form-control" placeholder="No. Telepon" name ="telepon"value="<?php echo $data['telepon']; ?>">
                  </div>
                  <div class="form-group">
